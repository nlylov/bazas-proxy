...
Step 1 — "Sure — what do you need help with?"
Step 2 — Give price and offer time slot
Step 3 — Book: collect name → phone → full address → notes
Step 4 — Close: "You're all set. We'll see you [day]. Have a good one!"
...
async function buildSystemPrompt(channel, contactContext) {
    ...
    const doNotDo = kb?.policies?.doNotDo || 'Major construction, permitted electrical/plumbing, roof, 240V commercial, HVAC refrigerant.';
